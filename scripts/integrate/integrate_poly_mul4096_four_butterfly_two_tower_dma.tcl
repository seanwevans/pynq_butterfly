...
set project_root F:/v/p4tt_dma
set project_name p4tt_dma
set design_name d

set ip_vlnv user.org:user:p4tt:1.0
set board_part tul.com.tw:pynq-z2:part0:1.0
set part_name xc7z020clg400-1

set deploy_dir [file join $source_root deploy poly_mul4096_four_butterfly_two_tower_dma]
set report_dir [file join $source_root reports poly_mul4096_four_butterfly_two_tower_dma]
...
if {![string match "*Complete*" $implementation_status]} {
    error "Four-butterfly board implementation failed: $implementation_status"
}
...
if {$wns_ns < 0.0} {
    error "Board overlay failed timing: WNS=$wns_ns ns"
}
...
set artifact_name poly_mul4096_four_butterfly_two_tower_dma
set bit_destination [file join $deploy_dir ${artifact_name}.bit]
set hwh_destination [file join $deploy_dir ${artifact_name}.hwh]
set xsa_destination [file join $deploy_dir ${artifact_name}.xsa]
...
set board_test_source [file join $source_root scripts board run test_poly_mul4096_four_butterfly_two_tower_dma.py]
set board_run_source [file join $source_root scripts board run run_poly_mul4096_four_butterfly_two_tower_board.sh]
...
puts $fh "profile_frame_bytes=131080"
puts $fh "product_command=0x4d554c31"
puts $fh "product_frame_words=8193"
puts $fh "product_frame_bytes=65544"
puts $fh "result_frame_words=4096"
puts $fh "result_frame_bytes=32768"
puts $fh "core_cycles=22968"
puts $fh "core_latency_us=229.68"
puts $fh "direct_stream_lower_bound_cycles=39353"
puts $fh "direct_stream_lower_bound_us=393.53"
...
puts ""
puts "============================================================"
puts "FOUR-BUTTERFLY PYNQ-Z2 DMA OVERLAY COMPLETE"
puts "============================================================"
