...
set project_root F:/v/db2p
set project_name db2p
set design_name d

set ip_vlnv user.org:user:db2p:1.0
...
set deploy_dir \
    [file join \
        $source_root \
        deploy \
        poly_mul4096_dual_butterfly_two_tower_prefetch_dma \
    ]
...
if {![string match "*Complete*" $implementation_status]} {
    error "Prefetched DMA implementation failed: $implementation_status"
}
...
puts $fh "expected_core_ramb36=64"
puts $fh "per_product_core_cycles=631810"
puts $fh "transition_cycles_per_nonfinal_product=8193"
puts $fh "steady_state_cycles_per_product=640003"
puts $fh "steady_state_latency_us=6400.03"
...
puts ""
puts "============================================================"
puts "PREFETCHED PYNQ-Z2 DMA OVERLAY COMPLETE"
puts "============================================================"
...
puts "Transition/nonfinal:     8193"
puts "Steady-state cycles:     640003"
