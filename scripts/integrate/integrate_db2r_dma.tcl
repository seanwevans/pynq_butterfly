...
set project_root F:/v/db2r
set project_name db2r
set design_name d

set ip_vlnv user.org:user:db2r:1.0
...
set deploy_dir \
    [file join \
        $source_root \
        deploy \
        poly_mul4096_dual_butterfly_two_tower_buffered_dma \
    ]
...
if {![string match "*Complete*" $implementation_status]} {
    error "Buffered-handoff DMA implementation failed: $implementation_status"
}
...
puts $fh "profile_frame_bytes=131072"
...
puts $fh "expected_core_ramb36=72"
puts $fh "per_product_core_cycles=631810"
puts $fh "handoff_groups=1024"
puts $fh "handoff_cycles_per_nonfinal_product=1025"
puts $fh "steady_state_cycles_per_product=632835"
puts $fh "steady_state_latency_us=6328.35"
...
puts ""
puts "============================================================"
puts "BUFFERED-HANDOFF PYNQ-Z2 DMA OVERLAY COMPLETE"
puts "============================================================"
...
puts "Handoff/nonfinal:        1025"
puts "Steady-state cycles:     632835"
