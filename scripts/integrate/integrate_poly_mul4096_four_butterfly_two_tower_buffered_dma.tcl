...
set project_name p4ttbo_dma
set design_name d

set ip_vlnv user.org:user:p4ttbo:1.0
set board_part tul.com.tw:pynq-z2:part0:1.0
set part_name xc7z020clg400-1

set artifact_name poly_mul4096_four_butterfly_two_tower_buffered_dma
...
if {![string match "*Complete*" $implementation_status]} {
    error "Buffered four-butterfly board implementation failed: $implementation_status"
}
...
if {$wns_ns < 0.0} {
    error "Buffered board overlay failed timing: WNS=$wns_ns ns"
}
...
set board_test_source [file join $source_root scripts board run test_poly_mul4096_four_butterfly_two_tower_buffered_dma.py]
set board_run_source [file join $source_root scripts board run run_poly_mul4096_four_butterfly_two_tower_buffered_board.sh]
...
puts $fh "handoff_cycles_per_product=1025"
puts $fh "steady_cycles_per_product=23993"
puts $fh "steady_us_per_product=239.93"
puts $fh "steady_products_per_second=4167.88"
puts $fh "operand_prefetch_depth_products=1"
puts $fh "result_buffer_depth_products=1"
...
puts ""
puts "============================================================"
puts "BUFFERED FOUR-BUTTERFLY PYNQ-Z2 OVERLAY COMPLETE"
puts "============================================================"
...
puts "Handoff cycles/product:  1025"
puts "Steady cycles/product:   23993"
