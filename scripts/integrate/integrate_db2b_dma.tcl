...
set project_root F:/v/db2b
set project_name db2b
set design_name d

set ip_vlnv user.org:user:db2b:1.0
...
if {![string match "*Complete*" $implementation_status]} {
    error "Batched DMA implementation failed: $implementation_status"
}
...
puts $fh "batch2_core_plus_drain_latency_us=12636.22"
...
puts ""
puts "============================================================"
puts "BATCHED PYNQ-Z2 DMA OVERLAY COMPLETE"
puts "============================================================"
...
puts "Batch-2 core+drain:      1263622 clocks"
