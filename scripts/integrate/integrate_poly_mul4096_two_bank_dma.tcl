...
set ip_repo [file join $root_dir ip]
set ip_vlnv user.org:user:poly_mul4096_two_bank_axis:1.0

set project_root F:/repos/pynq_poly_mul4096_two_bank_dma
set project_name pynq_poly_mul4096_two_bank_dma
set design_name design_1

set board_part tul.com.tw:pynq-z2:part0:1.0
set part_name xc7z020clg400-1

set deploy_dir [file join $root_dir deploy poly_mul4096_two_bank_dma]
set report_dir [file join $root_dir reports poly_mul4096_two_bank_dma]
...
set_property \
    -dict [list CONFIG.C_EXT_RESET_HIGH {0}] \
    $reset_block
...
connect_bd_intf_net \
    ...
    [get_bd_intf_pins poly_mul4096_two_bank_axis_0/s_axis]

connect_bd_intf_net \
    [get_bd_intf_pins poly_mul4096_two_bank_axis_0/m_axis] \
...
connect_bd_net \
    ...
    [get_bd_pins poly_mul4096_two_bank_axis_0/clk]
...
connect_bd_net \
    ...
    [get_bd_pins poly_mul4096_two_bank_axis_0/reset_n]
...
if {![string match "*Complete*" $implementation_status]} {
    error "Two-bank N=4096 DMA-overlay implementation failed: $implementation_status"
}

open_run impl_1

set timing_report \
    [file join $report_dir poly_mul4096_two_bank_dma_timing.rpt]

set utilization_report \
    [file join $report_dir poly_mul4096_two_bank_dma_utilization.rpt]
...
set bit_destination \
    [file join $deploy_dir poly_mul4096_two_bank_dma.bit]

set hwh_destination \
    [file join $deploy_dir poly_mul4096_two_bank_dma.hwh]
...
set xsa_destination \
    [file join $deploy_dir poly_mul4096_two_bank_dma.xsa]
...
puts $manifest_handle "overlay=poly_mul4096_two_bank_dma"
...
puts $manifest_handle "input_frame_words=8192"
puts $manifest_handle "input_frame_bytes=32768"
puts $manifest_handle "output_frame_words=4096"
puts $manifest_handle "output_frame_bytes=16384"
...
puts ""
puts "============================================================"
puts "PYNQ-Z2 N=4096 TWO-BANK DMA OVERLAY COMPLETE"
puts "============================================================"
