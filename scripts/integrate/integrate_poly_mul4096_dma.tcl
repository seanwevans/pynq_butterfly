...
set ip_vlnv user.org:user:poly_mul4096_axis:1.0

set project_root F:/repos/pynq_poly_mul4096_dma
set project_name pynq_poly_mul4096_dma
set design_name design_1

set board_part tul.com.tw:pynq-z2:part0:1.0
set part_name xc7z020clg400-1

set deploy_dir [file join $root_dir deploy poly_mul4096_dma]
set report_dir [file join $root_dir reports poly_mul4096_dma]
...
proc require_single_object {objects description} {
...
connect_bd_intf_net \
    ...
    [get_bd_intf_pins poly_mul4096_axis_0/s_axis]

connect_bd_intf_net \
    [get_bd_intf_pins poly_mul4096_axis_0/m_axis] \
...
connect_bd_net \
    ...
    [get_bd_pins poly_mul4096_axis_0/clk]
...
connect_bd_net \
    ...
    [get_bd_pins poly_mul4096_axis_0/reset_n]
...
if {![string match "*Complete*" $implementation_status]} {
    error "N=4096 DMA-overlay implementation failed: $implementation_status"
}

open_run impl_1

set timing_report \
    [file join $report_dir poly_mul4096_dma_timing.rpt]

set utilization_report \
    [file join $report_dir poly_mul4096_dma_utilization.rpt]
...
set bit_destination \
    [file join $deploy_dir poly_mul4096_dma.bit]

set hwh_destination \
    [file join $deploy_dir poly_mul4096_dma.hwh]
...
set xsa_destination \
    [file join $deploy_dir poly_mul4096_dma.xsa]
...
puts $manifest_handle "overlay=poly_mul4096_dma"
...
puts $manifest_handle "core_cycles=1376268"
puts $manifest_handle "core_latency_us=13762.68"
...
puts ""
puts "============================================================"
puts "PYNQ-Z2 N=4096 DMA OVERLAY COMPLETE"
puts "============================================================"
