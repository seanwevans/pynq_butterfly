...
#
# Usage:
#   vivado -mode batch -source build_evalmul3_dma150_overlay.tcl \
#     -tclargs REPO_ROOT BUILD_ROOT DEPLOY_DIR

if {[llength $argv] != 3} {
    puts stderr \
        "usage: build_evalmul3_dma150_overlay.tcl REPO_ROOT BUILD_ROOT DEPLOY_DIR"
    exit 2
}
...
set project_name "evalmul3_dma150"
set bd_name "d"
...
summary_puts $summary_file "EVALMUL3_DMA150_BUILD_BEGIN"
...
summary_puts $summary_file \
    "EVALMUL3_DMA150_WNS_NS=$wns"

summary_puts $summary_file \
    "EVALMUL3_DMA150_FAILING_PATHS=[llength $failing_paths]"

summary_puts $summary_file \
    "EVALMUL3_DMA150_LUTS=$lut_count"

summary_puts $summary_file \
    "EVALMUL3_DMA150_REGISTERS=$register_count"

summary_puts $summary_file \
    "EVALMUL3_DMA150_DSP48E1=$dsp_count"

summary_puts $summary_file \
    "EVALMUL3_DMA150_RAMB18E1=$ramb18_count"

summary_puts $summary_file \
    "EVALMUL3_DMA150_RAMB36E1=$ramb36_count"

if {$wns < 0.000} {
    summary_puts $summary_file \
        "FAIL: DMA overlay missed 100 MHz"
...
write_hw_platform \
    ...
    [file join \
        $build_root \
        "evalmul3_two_tower_dma150_platform.xsa"]
...
summary_puts $summary_file \
    "PASS: fused evaluation-domain dual-clock DMA overlay routed"

summary_puts $summary_file \
    "EVALMUL3_DMA150_BUILD_END"
