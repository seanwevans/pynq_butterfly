...
required=(
  ...
  "$ROOT/scripts/vivado/build_evalmul3_dma_overlay.tcl"
  "$ROOT/host/openfhe/python/pynq_butterfly/cli/run_fpga_evalmul3.py"
)
...
tcl_windows="$repo_windows\\scripts\\vivado\\build_evalmul3_dma_overlay.tcl"

cmd_file="$WORK_DIR/run_evalmul3_dma_overlay.cmd"
