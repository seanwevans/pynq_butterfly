...
#
# Usage:
#   vivado -mode batch -source build_evalmul3_dma_overlay.tcl \
#     -tclargs REPO_ROOT BUILD_ROOT DEPLOY_DIR

if {[llength $argv] != 3} {
    puts stderr \
        "usage: build_evalmul3_dma_overlay.tcl REPO_ROOT BUILD_ROOT DEPLOY_DIR"
    exit 2
}
...
summary_puts $summary_file "EVALMUL3_DMA_BUILD_BEGIN"
...
summary_puts $summary_file \
    "EVALMUL3_DMA_WNS_NS=$wns"

summary_puts $summary_file \
    "EVALMUL3_DMA_FAILING_PATHS=[llength $failing_paths]"

summary_puts $summary_file \
    "EVALMUL3_DMA_LUTS=$lut_count"

summary_puts $summary_file \
    "EVALMUL3_DMA_REGISTERS=$register_count"

summary_puts $summary_file \
    "EVALMUL3_DMA_DSP48E1=$dsp_count"

summary_puts $summary_file \
    "EVALMUL3_DMA_RAMB18E1=$ramb18_count"

summary_puts $summary_file \
    "EVALMUL3_DMA_RAMB36E1=$ramb36_count"
...
write_hw_platform \
    ...
    [file join \
        $build_root \
        "evalmul3_two_tower_dma_platform.xsa"]
