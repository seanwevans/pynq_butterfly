...
WORK_DIR="${EVALMUL3_ALLPAIRS_WORK:-/mnt/f/v/evalmul3_allpairs_dma150_overlay}"
...
tcl_windows="$repo_windows\\scripts\\vivado\\build_evalmul3_allpairs_dma150_overlay.tcl"

cmd_file="$WORK_DIR/run_evalmul3_allpairs_dma150_overlay.cmd"
...
pass_marker='PASS: all-pair evaluation-domain dual-clock DMA overlay routed'
