...
WORK_DIR="${BV_KEYREUSE_160DSP_TIMING_SWEEP_WORK:-/mnt/f/v/bv_keyreuse_160dsp_timing_sweep}"
...
required=(
  ...
  "$ROOT/scripts/vivado/build_bv_keyreuse_160dsp_timing_sweep.tcl"
)
...
tcl_windows="$repo_windows\\scripts\\vivado\\build_bv_keyreuse_160dsp_timing_sweep.tcl"

cmd_file="$WORK_DIR/run_bv_keyreuse_160dsp_timing_sweep.cmd"
...
marker='PASS: 160-DSP coefficient-major evaluation-key-reuse core routed at 100 MHz'
