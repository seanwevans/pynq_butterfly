...
package_tcl="$repo/scripts/package/package_poly_mul4096_four_butterfly_two_tower_ip.tcl"
integrate_tcl="$repo/scripts/integrate/integrate_poly_mul4096_four_butterfly_two_tower_dma.tcl"
