...
set ip_repo F:/v/ip
set ip_root [file join $ip_repo p4tt_1_0]
set stage_dir [file join $ip_root src]
set project_dir F:/v/pkg_p4tt

set part_name xc7z020clg400-1
set top_name poly_mul4096_four_butterfly_two_tower_axis_core
...
set rtl_names [list \
    ...
    poly_mul4096_four_butterfly_two_tower_axis_core.sv \
]
...
set_property name p4tt $core
set_property display_name {Four-Butterfly Two-Tower N=4096 Multiplier} $core
set_property description {Runtime-profiled two-tower N=4096 negacyclic multiplier with four pipelined butterflies per tower, 64-bit AXI4-Stream input/output, and 22968-cycle arithmetic latency.} $core
...
puts ""
puts "============================================================"
puts "FOUR-BUTTERFLY TWO-TOWER IP PACKAGING COMPLETE"
puts "============================================================"
puts "IP root:       [file normalize $ip_root]"
puts "VLNV:          user.org:user:p4tt:1.0"
