...
set ip_root [file join $root_dir ip poly_mul4096_two_bank_axis_1_0]
set stage_dir [file join $ip_root staged_sources]
set project_dir [file join $root_dir vivado package_poly_mul4096_two_bank_axis]
...
set rtl_names [list \
    ...
    poly_mul4096_two_bank_core.sv \
    poly_mul4096_two_bank_axis_core.sv \
]
...
foreach name $rtl_names {
    ...
    # Packaged IP must not depend on repository-relative model paths.
...
create_project \
    -force \
    package_poly_mul4096_two_bank_axis \
    $project_dir \
    -part $part_name
...
set_property name poly_mul4096_two_bank_axis $core
set_property display_name \
    {N=4096 Two-Bank Negacyclic Polynomial Multiplier AXI4-Stream} \
    $core

set_property description \
    {Constant-time two-bank N=4096 negacyclic polynomial multiplier over q=1073692673 with AXI4-Stream input and output.} \
    $core
...
puts ""
puts "============================================================"
puts "N=4096 TWO-BANK AXI4-STREAM IP PACKAGING COMPLETE"
puts "============================================================"
puts "IP root:       [file normalize $ip_root]"
puts "VLNV:          user.org:user:poly_mul4096_two_bank_axis:1.0"
