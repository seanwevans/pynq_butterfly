...
set ip_repo F:/v/ip
set ip_root [file join $ip_repo db2p_1_0]
set stage_dir [file join $ip_root src]
set project_dir F:/v/pkg_db2p
...
set rtl_names [list \
    ...
    poly_mul4096_dual_butterfly_runtime_profile_prefetch_axis_core.sv \
    poly_mul4096_dual_butterfly_two_tower_prefetch_axis_core.sv \
]
...
set_property name db2p $core
set_property display_name {Prefetched Dual-Butterfly Two-Tower N=4096 Multiplier} $core
set_property description {Runtime-profiled two-tower N=4096 negacyclic multiplier with one-product operand prefetch, same-address result/refill overlap, and 64-bit AXI4-Stream batching.} $core
...
puts ""
puts "============================================================"
puts "PREFETCHED TWO-TOWER IP PACKAGING COMPLETE"
puts "============================================================"
puts "IP root:       [file normalize $ip_root]"
puts "VLNV:          user.org:user:db2p:1.0"
puts "Integrity:     $integrity"
puts "Core cycles:   631810 per product"
puts "Transition:    8193 clocks per nonfinal product"
puts "Core RAMB36:   64"
puts "============================================================"
puts ""
