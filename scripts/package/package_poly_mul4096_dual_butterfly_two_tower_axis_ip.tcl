...
set ip_root \
    [file join $root_dir ip poly_mul4096_dual_butterfly_two_tower_axis_1_0]

set stage_dir \
    [file join $ip_root staged_sources]

set project_dir \
    [file join $root_dir vivado package_poly_mul4096_dual_butterfly_two_tower_axis]
...
set rtl_names [list \
    ...
    poly_mul4096_dual_butterfly_runtime_profile_core.sv \
    poly_mul4096_dual_butterfly_runtime_profile_axis_core.sv \
    poly_mul4096_dual_butterfly_two_tower_axis_core.sv \
]
...
create_project \
    -force \
    package_poly_mul4096_dual_butterfly_two_tower_axis \
    $project_dir \
    -part $part_name
...
set_property \
    name \
    poly_mul4096_dual_butterfly_two_tower_axis \
    $core

set_property \
    display_name \
    {Parallel Two-Tower Dual-Butterfly N=4096 Polynomial Multiplier} \
    $core

set_property \
    description \
    {Two parallel runtime-programmable dual-butterfly N=4096 negacyclic polynomial multipliers using paired 64-bit AXI4-Stream frames.} \
    $core
...
puts ""
puts "============================================================"
puts "DUAL-BUTTERFLY TWO-TOWER AXI4-STREAM IP PACKAGING COMPLETE"
puts "============================================================"
puts "IP root:               [file normalize $ip_root]"
puts "VLNV:                  user.org:user:poly_mul4096_dual_butterfly_two_tower_axis:1.0"
puts "Integrity:             $integrity_result"
puts "Stream width:          64 bits"
puts "Profile frame:         16384 x 64-bit words"
puts "Product input frame:   8193 x 64-bit words"
puts "Product output:        4096 x 64-bit words"
puts "Parallel core cycles:  607234"
puts "Core latency at 100MHz: 6072.34 us"
puts "============================================================"
puts ""
