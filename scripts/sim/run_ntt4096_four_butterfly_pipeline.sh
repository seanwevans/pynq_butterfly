...
rtl="$repo/rtl"
build="$repo/build/ntt4096_four_butterfly_pipeline"
binary="$build/tb_ntt4096_four_butterfly_pipeline_transform_core"
...
required=(
    ...
    "$rtl/ntt4096_four_butterfly_pipeline_transform_core.sv"
    "$repo/tests/rtl/tb_ntt4096_four_butterfly_pipeline_transform_core.sv"
)
...
iverilog \
    -g2012 \
    -Wall \
    -s tb_ntt4096_four_butterfly_pipeline_transform_core \
    -o "$binary" \
    "${required[@]}"
