...
RUNNER="$ROOT/host/openfhe/python/pynq_butterfly/cli/run_fpga_bv_keyreuse_multi_pair_session.py"
...
required=(
  ...
  "$RUNNER"
  "$ROOT/scripts/board/run/run_bv_keyreuse_multi_pair_session_board.sh"
