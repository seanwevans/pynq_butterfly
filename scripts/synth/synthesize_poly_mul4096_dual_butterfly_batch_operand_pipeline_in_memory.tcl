...
set report_dir \
    [file join \
        $root_dir \
        reports \
        poly_mul4096_dual_butterfly_batch_operand_pipeline_in_memory \
    ]
...
set unpipelined_batch_lut \
    24228

set unpipelined_batch_registers \
    7506

set unpipelined_batch_ramb36 \
    48
...
set lut_delta \
    [expr {$lut_count - $unpipelined_batch_lut}]

set register_delta \
    [expr {$register_count - $unpipelined_batch_registers}]

set ramb36_delta \
    [expr {$ramb36_count - $unpipelined_batch_ramb36}]
...
puts $fh "operand_write_pipeline=true"
puts $fh "write_pipeline_throughput_words_per_cycle=1"
puts $fh "write_drain_cycles_per_product=1"
puts $fh "arithmetic_core_changed=false"
puts $fh "per_product_core_cycles=631810"
puts $fh "batch2_core_cycles=1263620"
puts $fh "batch2_write_drain_cycles=2"
puts $fh "batch2_core_plus_drain_cycles=1263622"
puts $fh "batch2_core_plus_drain_latency_us_at_100mhz=12636.22"
...
puts $fh "unpipelined_batch_lut=$unpipelined_batch_lut"
puts $fh "unpipelined_batch_registers=$unpipelined_batch_registers"
puts $fh "unpipelined_batch_ramb36=$unpipelined_batch_ramb36"
...
puts ""
puts "============================================================"
puts "BATCH OPERAND-PIPELINE SYNTHESIS COMPLETE"
puts "============================================================"
puts "LUTs:                         $lut_count"
...
puts "LUT delta:                    $lut_delta"
puts "Register delta:               $register_delta"
puts "RAMB36 delta:                 $ramb36_delta"
puts "WNS:                          $wns_ns ns"
puts "Datapath delay:               $datapath_ns ns"
puts "Logic levels:                 $logic_levels"
puts "Startpoint:                   $startpoint"
puts "Endpoint:                     $endpoint"
puts "Core cycles per product:      631810"
puts "Write-drain cycles/product:   1"
