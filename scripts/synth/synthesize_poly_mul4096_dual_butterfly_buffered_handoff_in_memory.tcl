...
set report_dir \
    [file join \
        $root_dir \
        reports \
        poly_mul4096_dual_butterfly_buffered_handoff_in_memory \
    ]

set top_name \
    poly_mul4096_dual_butterfly_two_tower_buffered_axis_core
...
set rtl_files [list \
    ...
    [file join $rtl_dir poly_mul4096_dual_butterfly_runtime_profile_handoff_core.sv] \
    [file join $rtl_dir poly_mul4096_dual_butterfly_runtime_profile_buffered_axis_core.sv] \
    [file join $rtl_dir poly_mul4096_dual_butterfly_two_tower_buffered_axis_core.sv] \
]
...
puts $fh "handoff_width_coefficients=4"
puts $fh "arithmetic_fsm_changed=false"
puts $fh "per_product_core_cycles=631810"
puts $fh "handoff_groups=1024"
puts $fh "handoff_cycles_target=1025"
puts $fh "steady_state_cycles_target=632835"
puts $fh "steady_state_latency_us_at_100mhz=6328.35"
puts $fh "expected_prefetch_ramb36=16"
puts $fh "expected_result_buffer_ramb36=8"
puts $fh "expected_total_ramb36=72"
...
puts ""
puts "============================================================"
puts "BUFFERED FOUR-WIDE HANDOFF SYNTHESIS COMPLETE"
puts "============================================================"
puts "LUTs:                    $lut_count"
...
puts "Handoff target:          1025 clocks"
puts "Steady-state target:     632835 clocks"
