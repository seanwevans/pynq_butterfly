...
set report_dir \
    [file join \
        $root_dir \
        reports \
        ntt4096_four_butterfly_shared_ab_implemented \
    ]

set part_name xc7z020clg400-1
set top_name ntt4096_four_butterfly_shared_ab_synthesis_top
...
puts ""
puts "============================================================"
puts "SHARED-A/B FOUR-BUTTERFLY NTT IMPLEMENTATION"
puts "============================================================"
...
set rtl_files [list \
    ...
    [file join $rtl_dir ntt4096_four_butterfly_pipeline_engine_core.sv] \
    [file join $rtl_dir ntt4096_four_butterfly_shared_ab_core.sv] \
    [file join $rtl_dir ntt4096_four_butterfly_shared_ab_synthesis_top.sv] \
]
...
puts $fh "n=4096"
puts $fh "shared_ntt_engines_per_tower=1"
puts $fh "transforms_per_sequence=3"
puts $fh "forward_transforms_per_sequence=2"
puts $fh "inverse_transforms_per_sequence=1"
puts $fh "transform_cycles=6276"
puts $fh "sequence_cycles=18831"
puts $fh "butterflies_per_cycle=4"
puts $fh "initiation_interval=1"
puts $fh "single_tower_dsp_expected=64"
puts $fh "two_tower_dsp_projection=128"
...
puts ""
puts "============================================================"
puts "SHARED-A/B FOUR-BUTTERFLY NTT IMPLEMENTATION COMPLETE"
puts "============================================================"
puts "LUTs:                    $lut_count"
...
puts "Sequence cycles:         18831"
puts "Two-tower DSP projection: 128"
