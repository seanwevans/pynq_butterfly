...
rtl="$repo/rtl"
build="$repo/build/poly_mul4096_four_butterfly_two_tower"
binary="$build/tb_poly_mul4096_four_butterfly_two_tower_core"
...
required=(
    ...
    "$repo/tests/rtl/tb_poly_mul4096_four_butterfly_two_tower_core.sv"
)
...
iverilog \
    -g2012 \
    -Wall \
    -s tb_poly_mul4096_four_butterfly_two_tower_core \
    -o "$binary" \
    "${required[@]}"
