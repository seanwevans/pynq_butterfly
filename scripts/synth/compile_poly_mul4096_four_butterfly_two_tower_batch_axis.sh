...
rtl="$repo/rtl"
build="$repo/build/poly_mul4096_four_butterfly_two_tower_batch_axis"
binary="$build/tb_poly_mul4096_four_butterfly_two_tower_batch_axis_core"
...
required=(
    ...
    "$rtl/poly_mul4096_four_butterfly_two_tower_batch_axis_core.sv"
    "$repo/tests/rtl/tb_poly_mul4096_four_butterfly_two_tower_batch_axis_core.sv"
)
...
iverilog \
    -g2012 \
    -Wall \
    -s tb_poly_mul4096_four_butterfly_two_tower_batch_axis_core \
    -o "$binary" \
    "${required[@]}"
