...
set project_root \
    [file join $root_dir vivado ntt4096_four_bank_coeff_store_synth]

set report_dir \
    [file join $root_dir reports ntt4096_four_bank_coeff_store_synth]

set project_name ntt4096_four_bank_coeff_store_synth
...
set xdc_file \
    [file join $project_root ntt4096_four_bank_coeff_store_synth.xdc]
...
if {![string match "*Complete*" $synthesis_status]} {
    error "Four-bank coefficient-store synthesis failed: $synthesis_status"
}

open_run synth_1

set utilization_report \
    [file join $report_dir ntt4096_four_bank_coeff_store_utilization.rpt]

set hierarchical_report \
    [file join $report_dir ntt4096_four_bank_coeff_store_hierarchical_utilization.rpt]

set timing_report \
    [file join $report_dir ntt4096_four_bank_coeff_store_timing.rpt]
...
set summary_file \
    [file join $report_dir ntt4096_four_bank_coeff_store_synthesis_summary.txt]
...
puts $fh "simultaneous_read_addresses=4"
puts $fh "simultaneous_write_addresses=4"
...
puts ""
puts "============================================================"
puts "N=4096 FOUR-BANK COEFFICIENT-STORE SYNTHESIS COMPLETE"
puts "============================================================"
puts "LUTs:                  $lut_count"
