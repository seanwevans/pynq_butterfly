...
set report_dir [file join $root_dir reports modmul_radix4_flat_compare]
set work_root [file join $root_dir vivado modmul_radix4_flat_compare]
...
puts ""
puts "============================================================"
puts "SYNTHESIZING FLAT RADIX-4 MODULAR MULTIPLIER"
puts "============================================================"

set radix4 [
    run_variant \
        radix4 \
        modmul_core_radix4_flat \
        $radix4_source \
        $part_name \
        $clock_period_ns \
        $work_root \
...
set summary_file [
    file join \
        $report_dir \
        modmul_radix4_flat_summary.txt
]
