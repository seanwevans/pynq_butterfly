...
set project_root \
    [file join $root_dir vivado poly_mul4096_dual_butterfly_two_tower_axis_timing_isolated_synth]

set report_dir \
    [file join $root_dir reports poly_mul4096_dual_butterfly_two_tower_axis_timing_isolated_synth]

set project_name poly_mul4096_dual_butterfly_two_tower_axis_timing_isolated_synth
...
set xdc_file \
    [file join $project_root poly_mul4096_dual_butterfly_two_tower_axis_timing_isolated_synth.xdc]
...
set summary_file \
    [file join $report_dir poly_mul4096_dual_butterfly_two_tower_axis_timing_isolated_synthesis_summary.txt]
...
puts $fh "parallel_core_cycle_speedup=[expr {1339394.0 / 631810.0}]"
puts $fh "fast_axis_integration_model_cycles=214018"
...
puts ""
puts "============================================================"
puts "PARALLEL TWO-TOWER TIMING-ISOLATED AXIS SYNTHESIS COMPLETE"
puts "============================================================"
puts "Tower lanes:              2"
