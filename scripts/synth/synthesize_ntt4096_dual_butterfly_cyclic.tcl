...
set project_root \
    [file join $root_dir vivado ntt4096_dual_butterfly_cyclic_synth]

set report_dir \
    [file join $root_dir reports ntt4096_dual_butterfly_cyclic_synth]

set project_name ntt4096_dual_butterfly_cyclic_synth
...
set xdc_file \
    [file join $project_root ntt4096_dual_butterfly_cyclic_synth.xdc]
...
if {![string match "*Complete*" $synthesis_status]} {
    error "Dual-butterfly cyclic NTT synthesis failed: $synthesis_status"
}

open_run synth_1

set utilization_report \
    [file join $report_dir ntt4096_dual_butterfly_cyclic_utilization.rpt]

set hierarchical_report \
    [file join $report_dir ntt4096_dual_butterfly_cyclic_hierarchical_utilization.rpt]

set timing_report \
    [file join $report_dir ntt4096_dual_butterfly_cyclic_timing.rpt]

set bram_cells_report \
    [file join $report_dir ntt4096_dual_butterfly_cyclic_bram_cells.txt]
...
set summary_file \
    [file join $report_dir ntt4096_dual_butterfly_cyclic_synthesis_summary.txt]
...
puts $fh "coefficient_words=4096"
puts $fh "coefficient_physical_banks=4"
puts $fh "coefficient_expected_ramb36=4"
puts $fh "twiddle_words=4096"
puts $fh "twiddle_read_ports=2"
puts $fh "twiddle_expected_ramb36=4"
puts $fh "expected_total_ramb36=8"
puts $fh "paired_entries_per_transform=12288"
...
puts $fh "structural_speedup=[expr {540673.0 / 270337.0}]"
...
puts ""
puts "============================================================"
puts "N=4096 DUAL-BUTTERFLY CYCLIC NTT SYNTHESIS COMPLETE"
puts "============================================================"
puts "LUTs:                  $lut_count"
...
puts "Butterfly lanes:       2"
puts "Transform cycles:      270337"
puts "Reference cycles:      540673"
puts "Expected RAMB36:       8"
