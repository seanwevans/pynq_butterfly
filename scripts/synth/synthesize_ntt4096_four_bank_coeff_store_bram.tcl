...
set project_root \
    [file join $root_dir vivado ntt4096_four_bank_coeff_store_bram_synth]

set report_dir \
    [file join $root_dir reports ntt4096_four_bank_coeff_store_bram_synth]

set project_name ntt4096_four_bank_coeff_store_bram_synth
set top_name ntt4096_four_bank_coeff_store
...
set xdc_file \
    [file join $project_root ntt4096_four_bank_coeff_store_bram_synth.xdc]
...
if {![string match "*Complete*" $synthesis_status]} {
    error "Four-bank BRAM coefficient-store synthesis failed: $synthesis_status"
}

open_run synth_1

set utilization_report \
    [file join $report_dir ntt4096_four_bank_coeff_store_bram_utilization.rpt]

set hierarchical_report \
    [file join $report_dir ntt4096_four_bank_coeff_store_bram_hierarchical_utilization.rpt]

set timing_report \
    [file join $report_dir ntt4096_four_bank_coeff_store_bram_timing.rpt]
...
set summary_file \
    [file join $report_dir ntt4096_four_bank_coeff_store_bram_synthesis_summary.txt]
...
puts $fh "logical_words=4096"
puts $fh "logical_word_bits=32"
puts $fh "physical_banks=4"
puts $fh "words_per_bank=1024"
puts $fh "bank_implementation=canonical_simple_dual_port"
puts $fh "expected_ramb36=4"
...
puts ""
puts "============================================================"
puts "N=4096 FOUR-BANK BRAM COEFFICIENT-STORE SYNTHESIS COMPLETE"
puts "============================================================"
puts "LUTs:                  $lut_count"
...
puts "Physical banks:        4"
puts "Words per bank:        1024"
puts "Expected RAMB36:       4"
