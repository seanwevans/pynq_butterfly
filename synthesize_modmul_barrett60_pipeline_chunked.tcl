...
set report_dir \
    [file join \
        $source_root \
        reports \
        modmul_barrett60_pipeline_chunked \
    ]

set part_name xc7z020clg400-1
set top_name modmul_barrett60_pipeline_chunked_core
...
set rtl_file \
    [file join \
        $rtl_dir \
        modmul_barrett60_pipeline_chunked_core.sv \
    ]
...
set dsp_cells_report \
    [file join $report_dir dsp_cells.txt]
...
set dsp_fh [open $dsp_cells_report w]
...
puts $fh "algorithm=barrett_2pow60"
puts $fh "pipeline_latency=9"
puts $fh "initiation_interval=1"
puts $fh "maximum_modulus_bits=30"
...
puts $fh "dsp_cells_report=[file normalize $dsp_cells_report]"

close $fh

puts ""
puts "============================================================"
puts "BARRETT PIPELINE SYNTHESIS COMPLETE"
puts "============================================================"
puts "LUTs:             $lut_count"
