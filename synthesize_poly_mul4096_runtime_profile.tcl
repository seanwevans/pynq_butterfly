...
set project_root [file join $root_dir vivado poly_mul4096_runtime_profile_synth]
set report_dir [file join $root_dir reports poly_mul4096_runtime_profile_synth]

set project_name poly_mul4096_runtime_profile_synth
set top_name poly_mul4096_runtime_profile_core
...
set xdc_file [file join $project_root poly_mul4096_runtime_profile_synth.xdc]
...
if {![string match "*Complete*" $synthesis_status]} {
    error "N=4096 runtime-profile synthesis failed: $synthesis_status"
}

open_run synth_1

set utilization_report \
    [file join $report_dir poly_mul4096_runtime_profile_utilization.rpt]

set hierarchical_report \
    [file join $report_dir poly_mul4096_runtime_profile_hierarchical_utilization.rpt]

set timing_report \
    [file join $report_dir poly_mul4096_runtime_profile_timing.rpt]
...
set summary_file \
    [file join $report_dir poly_mul4096_runtime_profile_synthesis_summary.txt]
...
puts $fh "runtime_profile_words=16382"
puts $fh "runtime_profile_bytes=65528"
...
puts ""
puts "============================================================"
puts "N=4096 RUNTIME-PROFILE SYNTHESIS COMPLETE"
puts "============================================================"
puts "LUTs:                  $lut_count"
...
puts "Coefficient banks:     2"
puts "Profile banks:         4"
puts "Runtime profile bytes: 65528"
