...
/*
 * Verilog-2001 AXI4-Stream module-reference top for the exact fused
 * EvalMul3 + host-decomposed OpenFHE BV relinearization core.
 *
 * Every accepted input word must carry all eight byte lanes. Output words are
 * always complete 64-bit values.
 */
module evalmul3_bv_relinearized_axis_dma_wrapper (
