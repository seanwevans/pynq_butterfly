 ...
 *     r    = z - qhat * q
 *
 * The 60x31 reciprocal product is split into two parallel 30x31
 * products and recombined one cycle later.
 *
 * Initiation interval: 1 clock
 * Input-to-output latency: 7 clocks
 */
module modmul_barrett60_pipeline_split_core (
    ...
    logic        valid_stage2;
    logic [60:0] reciprocal_low_stage2;
    logic [60:0] reciprocal_high_stage2;
    ...
    assign reciprocal_low_comb =
        product_stage1[29:0] * mu_stage1;

    assign reciprocal_high_comb =
        product_stage1[59:30] * mu_stage1;

    logic        valid_stage3;
    logic [90:0] reciprocal_product_stage3;
    ...
    assign reciprocal_product_combined =
        {30'd0, reciprocal_low_stage2}
        + (
            {30'd0, reciprocal_high_stage2}
            << 30
        );

    logic        valid_stage4;
    logic [30:0] quotient_stage4;
    logic [63:0] product_delay_stage4;
    logic [31:0] q_stage4;

    logic        valid_stage5;
    logic [62:0] quotient_product_stage5;
    ...
    assign quotient_product_comb =
        quotient_stage4 * q_stage4;

    logic        valid_stage6;
    logic [63:0] remainder_stage6;
    logic [31:0] q_stage6;
    ...
    begin
        ...
        begin
            ...
            reciprocal_low_stage2 <= 61'd0;
            reciprocal_high_stage2 <= 61'd0;
            product_delay_stage2 <= 64'd0;
            q_stage2 <= 32'd0;

            reciprocal_product_stage3 <= 91'd0;
            product_delay_stage3 <= 64'd0;
            q_stage3 <= 32'd0;

            quotient_stage4 <= 31'd0;
            product_delay_stage4 <= 64'd0;
            q_stage4 <= 32'd0;

            quotient_product_stage5 <= 63'd0;
            product_delay_stage5 <= 64'd0;
            q_stage5 <= 32'd0;

            remainder_stage6 <= 64'd0;
            q_stage6 <= 32'd0;
        ...
        begin
            ...
            reciprocal_low_stage2 <=
                reciprocal_low_comb;

            reciprocal_high_stage2 <=
            ...
            quotient_stage4 <=
                reciprocal_product_stage3[90:60];
            ...
            begin
                result <=
                    remainder_stage6 >= {32'd0, q_stage6}
                        ? remainder_stage6[31:0] - q_stage6
                        : remainder_stage6[31:0];
            end
        end
    end
...
`ifndef SYNTHESIS
    ...
    begin
        ...
        if (
            reset_n
            && valid_stage6
            && remainder_stage6 >= ({32'd0, q_stage6} << 1)
        )
        begin
            $display(
