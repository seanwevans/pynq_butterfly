...
/*
 * Two-lane runtime-profile N=4096 polynomial multiplier.
 *
 ...
 */
module poly_mul4096_runtime_profile_dual_axis_core (
    input  logic        clk,
    input  logic        reset_n,
    ...
    poly_mul4096_runtime_profile_axis_core lane0 (
        .clk                       (clk),
        .reset_n                   (reset_n),
    ...
    poly_mul4096_runtime_profile_axis_core lane1 (
        .clk                       (clk),
        .reset_n                   (reset_n),
