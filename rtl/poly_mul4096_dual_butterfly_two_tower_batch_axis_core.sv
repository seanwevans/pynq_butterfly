 ...
 * Batch input:
 *
 *     2 + batch_count * 8192 x 64-bit words
 *
 ...
 * Batch output:
 *
 *     batch_count * 4096 x 64-bit words
 */
module poly_mul4096_dual_butterfly_two_tower_batch_axis_core (
    input  logic        clk,
    input  logic        reset_n,
    ...
    poly_mul4096_dual_butterfly_runtime_profile_batch_axis_core lane0 (
        .clk                       (clk),
        .reset_n                   (reset_n),
    ...
    poly_mul4096_dual_butterfly_runtime_profile_batch_axis_core lane1 (
        .clk                       (clk),
        .reset_n                   (reset_n),
...
`ifndef SYNTHESIS
    ...
    begin
        ...
        begin
            ...
            begin
                $display(
                    "ERROR: dual lanes completed different batch counts"
                );
