...
/*
 * Registered synthesis/implementation shell for the pipelined transform.
 */
module ntt4096_four_butterfly_pipeline_transform_synthesis_top (
    input  logic        clk,
    input  logic        reset_n,
    ...
    ntt4096_four_butterfly_pipeline_transform_core core (
        .clk             (clk),
        .reset_n         (reset_n_q),
        ...
        .twiddle_we      (twiddle_we_q),
        .twiddle_addr    (twiddle_addr_q),
        .twiddle_data    (twiddle_data_q),

        .load_we         (load_we_q),
        .load_addr       (load_addr_q),
        ...
        .start           (start_q),
        .inverse_mode    (inverse_mode_q),

        .busy            (inner_busy),
        .done            (inner_done),
        .cycles          (inner_cycles),
        .butterfly_count (inner_butterfly_count)
    );
