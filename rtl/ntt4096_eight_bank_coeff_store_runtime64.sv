...
/*
 * Eight-bank 4096 x 64 store using the same conflict-free logical-address
 * mapping as the arithmetic coefficient stores.
 */
module ntt4096_eight_bank_coeff_store_runtime64 (
    input  logic              clk,
    ...
    generate
        ...
        begin : banks
            ntt4096_coeff_bank_512x64 bank (
                .clk        (clk),
...
`ifndef SYNTHESIS
    ...
    begin
        ...
        begin
            $display(
                "ERROR: 64-bit store scalar load and wide write overlap"
            );
