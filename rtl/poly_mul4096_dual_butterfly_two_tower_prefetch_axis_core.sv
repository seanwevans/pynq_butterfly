...
/*
 * Two lockstep RNS towers using the one-product prefetch adapter.
 * Each 64-bit stream word carries lane 0 in bits 31:0 and lane 1 in
 * bits 63:32.
 */
module poly_mul4096_dual_butterfly_two_tower_prefetch_axis_core (
    input  logic        clk,
    input  logic        reset_n,
    ...
    poly_mul4096_dual_butterfly_runtime_profile_prefetch_axis_core lane0 (
        .clk                       (clk),
        .reset_n                   (reset_n),
    ...
    poly_mul4096_dual_butterfly_runtime_profile_prefetch_axis_core lane1 (
        .clk                       (clk),
        .reset_n                   (reset_n),
...
`ifndef SYNTHESIS
    ...
    begin
        ...
        begin
            ...
            begin
                $display(
                    "ERROR: prefetch RNS lanes left counter lockstep"
                );
            ...
            begin
                $display(
                    "ERROR: prefetch result lanes left valid lockstep"
                );
            ...
            begin
                $display(
                    "ERROR: prefetch result lanes disagreed on TLAST"
                );
            ...
            begin
                $display(
                    "ERROR: prefetch RNS lanes reported different cycles"
                );
