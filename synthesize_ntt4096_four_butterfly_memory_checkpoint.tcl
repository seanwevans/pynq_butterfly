...
set report_dir \
    [file join \
        $source_root \
        reports \
        ntt4096_four_butterfly_memory_checkpoint \
    ]

set part_name xc7z020clg400-1
set top_name ntt4096_four_butterfly_memory_synthesis_top
...
set rtl_files [list \
    ...
    [file join $rtl_dir ntt4096_eight_bank_coeff_store.sv] \
    [file join $rtl_dir ntt4096_four_butterfly_memory_checkpoint_top.sv] \
    [file join $rtl_dir ntt4096_four_butterfly_memory_synthesis_top.sv] \
]
...
if {[llength $data_inputs] == 0} {
    error "No non-clock input ports were found for timing constraints"
}

if {[llength $data_outputs] == 0} {
    error "No output ports were found for timing constraints"
}
...
puts $fh "coefficient_count=4096"
puts $fh "coefficient_width_bits=32"
puts $fh "bank_count=8"
puts $fh "rows_per_bank=512"
...
puts $fh "read_ports=8"
puts $fh "write_ports=8"
puts $fh "expected_ramb18=8"
puts $fh "expected_ramb36=0"
puts $fh "expected_bram_tile_equivalent=4.0"
...
puts ""
puts "============================================================"
puts "FOUR-BUTTERFLY MEMORY CHECKPOINT SYNTHESIS COMPLETE"
puts "============================================================"
puts "Registered shell:        true"
puts "LUTs:                    $lut_count"
