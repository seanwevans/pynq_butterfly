...
def main() -> int:
    ...
    require_equal(values, "shared_ntt_engines_per_tower", "1")
    require_equal(values, "transforms_per_sequence", "3")
    require_equal(values, "transform_cycles", "6276")
    require_equal(values, "sequence_cycles", "18831")
    require_equal(values, "butterflies_per_cycle", "4")
    require_equal(values, "initiation_interval", "1")
    require_equal(values, "dsp", "64")
    require_equal(values, "ramb18", "16")
    require_equal(values, "ramb36", "16")
    ...
    print("Shared-A/B four-butterfly NTT implementation")
    ...
    print(f"  sequence cycles:     {values['sequence_cycles']}")
    ...
    print("PASS: shared-A/B NTT checkpoint meets requirements")
    return 0
