...
/*
 * Consolidated two-bank N=4096 negacyclic polynomial multiplier.
 *
 * Ring:
 *
 *     Z_q[X] / (X^4096 + 1)
 ...
 * ROM architecture:
 *
 *     one shared twist-factor ROM
 *     one shared forward-twiddle ROM
 *     one inverse-twiddle ROM
 *     one inverse-scale ROM
 *
...
module poly_mul4096_two_bank_core #(
    ...
    ntt4096_twiddle_rom #(
        ...
        .clk       (clk),
        .enable    (forward_twiddle_enable),
        .address   (forward_twiddle_addr),
    ...
    ntt4096_twiddle_rom #(
        ...
        .clk       (clk),
        .enable    (inverse_twiddle_enable),
        .address   (inverse_twiddle_addr),
