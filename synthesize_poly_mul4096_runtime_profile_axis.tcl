...
set project_root [file join $root_dir vivado poly_mul4096_runtime_profile_axis_synth]
set report_dir [file join $root_dir reports poly_mul4096_runtime_profile_axis_synth]

set project_name poly_mul4096_runtime_profile_axis_synth
...
set xdc_file \
    [file join $project_root poly_mul4096_runtime_profile_axis_synth.xdc]
...
if {![string match "*Complete*" $synthesis_status]} {
    error "N=4096 runtime-profile AXI4-Stream synthesis failed: $synthesis_status"
}

open_run synth_1

set utilization_report \
    [file join $report_dir poly_mul4096_runtime_profile_axis_utilization.rpt]

set hierarchical_report \
    [file join $report_dir poly_mul4096_runtime_profile_axis_hierarchical_utilization.rpt]

set timing_report \
    [file join $report_dir poly_mul4096_runtime_profile_axis_timing.rpt]
...
set summary_file \
    [file join $report_dir poly_mul4096_runtime_profile_axis_synthesis_summary.txt]
...
puts $fh "profile_banks=4"
puts $fh "profile_frame_words=16384"
puts $fh "profile_frame_bytes=65536"
puts $fh "profile_payload_words=16382"
puts $fh "product_input_frame_words=8193"
puts $fh "product_input_frame_bytes=32772"
puts $fh "product_output_frame_words=4096"
puts $fh "product_output_frame_bytes=16384"
...
puts ""
puts "============================================================"
puts "N=4096 RUNTIME-PROFILE AXI4-STREAM SYNTHESIS COMPLETE"
puts "============================================================"
puts "LUTs:                  $lut_count"
...
puts "Profile frame bytes:   65536"
puts "Product input bytes:   32772"
puts "Product output bytes:  16384"
