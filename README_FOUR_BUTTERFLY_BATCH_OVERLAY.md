...
```bash
./compile_poly_mul4096_four_butterfly_two_tower_batch_axis.sh
```
...
```bash
./build_poly_mul4096_four_butterfly_two_tower_batch_board.sh
```
...
```bash
./install_poly_mul4096_four_butterfly_two_tower_batch_board.sh pynq
```
...
./run_poly_mul4096_four_butterfly_two_tower_batch_board.sh
```

Optional arguments are batch-size CSV and timed runs:

```bash
./run_poly_mul4096_four_butterfly_two_tower_batch_board.sh 1,4,16,32 10
```
