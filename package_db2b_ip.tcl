...
set ip_repo F:/v/ip
set ip_root [file join $ip_repo db2b_1_0]
set stage_dir [file join $ip_root src]
set project_dir F:/v/pkg_db2b

set part_name xc7z020clg400-1
set top_name poly_mul4096_dual_butterfly_two_tower_batch_axis_core
...
set rtl_names [list \
    ...
    poly_mul4096_dual_butterfly_runtime_profile_batch_axis_core.sv \
    poly_mul4096_dual_butterfly_two_tower_batch_axis_core.sv \
]
...
set_property name db2b $core
set_property display_name {Batched Dual-Butterfly Two-Tower N=4096 Multiplier} $core
set_property description {Runtime-profiled two-tower N=4096 negacyclic multiplier with timing-isolated operand writes and batched 64-bit AXI4-Stream operation.} $core
...
puts ""
puts "============================================================"
puts "BATCHED TWO-TOWER IP PACKAGING COMPLETE"
puts "============================================================"
puts "IP root:     [file normalize $ip_root]"
puts "VLNV:        user.org:user:db2b:1.0"
puts "Integrity:   $integrity"
puts "MULB:        0x4d554c42"
puts "Core cycles: 631810 per product"
puts "Drain cost:  1 clock per product"
puts "============================================================"
puts ""
