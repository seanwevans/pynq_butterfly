...
set project_root [file join $root_dir vivado poly_mul4096_axis_synth]
set report_dir [file join $root_dir reports poly_mul4096_axis_synth]

set project_name poly_mul4096_axis_synth
set top_name poly_mul4096_axis_core
...
set rtl_files [list \
    ...
    [file join $rtl_dir ntt4096_cyclic_core.sv] \
    [file join $rtl_dir forward_ntt4096_core.sv] \
    [file join $rtl_dir inverse_ntt4096_core.sv] \
    [file join $rtl_dir pointwise_mul4096_core.sv] \
    [file join $rtl_dir poly_mul4096_core.sv] \
    [file join $rtl_dir poly_mul4096_axis_core.sv] \
]
...
set xdc_file [file join $project_root poly_mul4096_axis_synth.xdc]
...
if {![string match "*Complete*" $synthesis_status]} {
    error "N=4096 AXI4-Stream synthesis failed: $synthesis_status"
}

open_run synth_1

set utilization_report \
    [file join $report_dir poly_mul4096_axis_utilization.rpt]

set hierarchical_report \
    [file join $report_dir poly_mul4096_axis_hierarchical_utilization.rpt]

set timing_report \
    [file join $report_dir poly_mul4096_axis_timing.rpt]
...
set summary_file \
    [file join $report_dir poly_mul4096_axis_synthesis_summary.txt]
...
puts $fh "core_cycles=1376268"
puts $fh "core_latency_us_at_100mhz=13762.68"
...
puts ""
puts "============================================================"
puts "N=4096 AXI4-STREAM SYNTHESIS COMPLETE"
puts "============================================================"
puts "LUTs:                  $lut_count"
