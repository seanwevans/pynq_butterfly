...
set project_root [file join $root_dir vivado poly_mul4096_two_bank_synth]
set report_dir [file join $root_dir reports poly_mul4096_two_bank_synth]

set project_name poly_mul4096_two_bank_synth
set top_name poly_mul4096_two_bank_core
...
set xdc_file [file join $project_root poly_mul4096_two_bank_synth.xdc]
...
if {![string match "*Complete*" $synthesis_status]} {
    error "N=4096 two-bank synthesis failed: $synthesis_status"
}

open_run synth_1

set utilization_report \
    [file join $report_dir poly_mul4096_two_bank_utilization.rpt]

set hierarchical_report \
    [file join $report_dir poly_mul4096_two_bank_hierarchical_utilization.rpt]

set timing_report \
    [file join $report_dir poly_mul4096_two_bank_timing.rpt]
...
set summary_file \
    [file join $report_dir poly_mul4096_two_bank_synthesis_summary.txt]
...
puts $fh "previous_core_cycles=1376268"
puts $fh "cycles_removed=36874"
...
puts ""
puts "============================================================"
puts "N=4096 TWO-BANK SYNTHESIS COMPLETE"
puts "============================================================"
puts "LUTs:                  $lut_count"
