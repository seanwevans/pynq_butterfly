...
set ip_repo F:/v/ip
set ip_root [file join $ip_repo p4ttbo_1_0]
set stage_dir [file join $ip_root src]
set project_dir F:/v/pkg_p4ttbo

set part_name xc7z020clg400-1
set top_name poly_mul4096_four_butterfly_two_tower_buffered_axis_core
...
set rtl_names [list \
    ...
    ntt4096_coeff_bank_1024x64.sv \
    ntt4096_eight_bank_coeff_store_runtime.sv \
    ntt4096_eight_bank_coeff_store_runtime_handoff4.sv \
    ntt4096_four_bank_coeff_store_runtime64.sv \
    ntt4096_four_butterfly_schedule_core.sv \
    poly_mul4096_four_lane_arithmetic_core.sv \
    poly_mul4096_four_butterfly_pipeline_runtime_profile_handoff_core.sv \
    poly_mul4096_four_butterfly_two_tower_handoff_core.sv \
    poly_mul4096_four_butterfly_two_tower_buffered_axis_core.sv \
]
...
set_property name p4ttbo $core
set_property display_name {Four-Wide Buffered Four-Butterfly Two-Tower N=4096 Multiplier} $core
set_property description {Runtime-profiled two-tower N=4096 negacyclic multiplier with four pipelined butterflies per tower, one-product operand prefetch, localized four-wide result/refill handoff, and decoupled result buffering.} $core
...
puts ""
puts "============================================================"
puts "BUFFERED FOUR-BUTTERFLY FOUR-WIDE BUFFERED IP PACKAGING COMPLETE"
puts "============================================================"
puts "IP root:          [file normalize $ip_root]"
puts "VLNV:             user.org:user:p4ttbo:1.0"
puts "Core revision:    3"
puts "Integrity:        $integrity"
puts "Core cycles:      22968"
puts "Handoff cycles:   1025"
puts "Steady cadence:   23993 cycles/product"
puts "============================================================"
puts ""
