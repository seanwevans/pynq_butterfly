...
set ip_repo F:/v/ip
set ip_root [file join $ip_repo db2ti_1_1]
set stage_dir [file join $ip_root src]
set project_dir F:/v/pkg_db2ti
...
set_property name db2ti $core
set_property display_name {Timing-Isolated Dual-Butterfly Two-Tower N=4096 Multiplier} $core
set_property description {Two parallel runtime-programmable N=4096 negacyclic polynomial multipliers with registered butterfly inputs and paired 64-bit AXI4-Stream frames.} $core
...
puts ""
puts "============================================================"
puts "TIMING-ISOLATED IP PACKAGING COMPLETE"
puts "============================================================"
puts "IP root:  [file normalize $ip_root]"
puts "VLNV:     user.org:user:db2ti:1.1"
puts "Integrity: $integrity"
puts "Core cycles: 631810"
puts "Core latency at 100 MHz: 6318.10 us"
puts "============================================================"
puts ""
