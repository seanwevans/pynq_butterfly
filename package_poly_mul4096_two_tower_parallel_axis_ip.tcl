...
set ip_root \
    [file join $root_dir ip poly_mul4096_two_tower_parallel_axis_1_0]

set stage_dir \
    [file join $ip_root staged_sources]

set project_dir \
    [file join $root_dir vivado package_poly_mul4096_two_tower_parallel_axis]
...
set rtl_names [list \
    ...
    poly_mul4096_runtime_profile_dual_axis_core.sv \
]
...
create_project \
    -force \
    package_poly_mul4096_two_tower_parallel_axis \
    $project_dir \
    -part $part_name
...
set_property \
    name \
    poly_mul4096_two_tower_parallel_axis \
    $core

set_property \
    display_name \
    {Parallel Two-Tower Runtime-Profile N=4096 Polynomial Multiplier} \
    $core

set_property \
    description \
    {Two parallel runtime-programmable constant-time N=4096 negacyclic polynomial multipliers using paired 64-bit AXI4-Stream frames.} \
    $core
...
puts ""
puts "============================================================"
puts "PARALLEL TWO-TOWER AXI4-STREAM IP PACKAGING COMPLETE"
puts "============================================================"
puts "IP root:             [file normalize $ip_root]"
puts "VLNV:                user.org:user:poly_mul4096_two_tower_parallel_axis:1.0"
