...
package_tcl="$repo/package_poly_mul4096_four_butterfly_two_tower_batch_ip.tcl"
integrate_tcl="$repo/integrate_poly_mul4096_four_butterfly_two_tower_batch_dma.tcl"
