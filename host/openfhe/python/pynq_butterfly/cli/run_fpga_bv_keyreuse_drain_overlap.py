...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Run exact compute-drain-overlap coefficient-major EvalMult plus "
    ...
    print(
        "Preparing exact paired-tower source vectors for drain-overlap overlay..."
    )
    ...
    print()
    print(
        "PASS: every drain-overlap coefficient-major RLCM result "
        "matches OpenFHE"
    )
