...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Convert the generated two-tower OpenFHE vectors into "
            "readmemh inputs for the full dual-butterfly polynomial "
    ...
    for tower_index in range(2):
        ...
        print(
            f"PASS: prepared tower {tower_index} polynomial vectors"
        )
