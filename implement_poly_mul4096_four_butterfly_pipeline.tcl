...
set top_name poly_mul4096_four_butterfly_pipeline_synthesis_top
...
puts ""
puts "============================================================"
puts "FOUR-BUTTERFLY PIPELINED POLYNOMIAL IMPLEMENTATION"
puts "============================================================"
...
set rtl_files [list \
    ...
    [file join $rtl_dir poly_mul4096_four_butterfly_pipeline_synthesis_top.sv] \
]
...
puts $fh "n=4096"
puts $fh "ring=X^4096+1"
puts $fh "shared_arithmetic_lanes=4"
puts $fh "barrett_pipeline_latency=7"
puts $fh "arithmetic_vector_latency=9"
puts $fh "initiation_interval=1"
puts $fh "legacy_product_cycles=631810"
puts $fh "product_cycle_target_upper_bound=25000"
...
puts ""
puts "============================================================"
puts "FOUR-BUTTERFLY PIPELINED POLYNOMIAL IMPLEMENTATION COMPLETE"
puts "============================================================"
puts "LUTs:                    $lut_count"
