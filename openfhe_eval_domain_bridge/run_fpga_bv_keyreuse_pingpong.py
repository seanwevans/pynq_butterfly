...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Run exact ping-pong coefficient-major EvalMult plus "
    ...
    print(
        "Preparing exact paired-tower source vectors for ping-pong overlay..."
    )
    ...
    print()
    print(
        "PASS: every ping-pong coefficient-major RLCM result "
        "matches OpenFHE"
    )
