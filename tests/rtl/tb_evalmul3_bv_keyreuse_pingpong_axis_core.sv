...
module tb_evalmul3_bv_keyreuse_pingpong_axis_core;
    ...
    evalmul3_bv_keyreuse_pingpong_axis_core #(
        .N                (N),
        .MAX_BATCH        (8),
        .MIN_BATCH        (8),
        .MAX_DIGITS       (16),
    ...
    begin
        ...
        begin
            $display(
                "ERROR: ping-pong simulation observed no simultaneous input/output handshakes"
            );
        ...
        $display(
            "PINGPONG_OVERLAP_HANDSHAKES=%0d",
            overlap_handshakes
        );
