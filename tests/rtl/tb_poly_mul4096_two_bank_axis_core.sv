...
module tb_poly_mul4096_two_bank_axis_core;
    ...
    poly_mul4096_two_bank_axis_core dut (
        .clk                     (clk),
        .reset_n                 (reset_n),
    ...
    task automatic stream_input_frame;
        begin
            ...
            $display(
                "PASS: streamed 8192-word two-bank input frame"
            );
        end
    endtask
    ...
    task automatic receive_output_frame(
        ...
        begin
            ...
            $display(
                "PASS: received 4096-word two-bank result frame %0d",
                requested_product
            );
        end
    endtask
    ...
    begin
        ...
        begin
            ...
            begin
                $display(
                    "FAIL CORE CYCLES product=%0d result=%0d expected=%0d",
                    product_index,
                    core_cycles,
        ...
        $display(
            "PASS: two streamed consolidated N=4096 products"
        );
        ...
        $display(
            "Constant two-bank core cycles: %0d",
            core_cycles
        );

        $display(
            "Expected two-bank core latency at 100 MHz: 13393.94 us"
        );
