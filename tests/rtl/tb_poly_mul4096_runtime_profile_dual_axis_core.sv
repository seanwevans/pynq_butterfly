...
module tb_poly_mul4096_runtime_profile_dual_axis_core;
    ...
    poly_mul4096_runtime_profile_dual_axis_core dut (
        .clk                           (clk),
        .reset_n                       (reset_n),
    ...
    begin
        ...
        $readmemh(
            "generated_dual_lane/tower0_a.mem",
            tower0_a
        );

        $readmemh(
            "generated_dual_lane/tower1_a.mem",
            tower1_a
        );

        $readmemh(
            "generated_dual_lane/tower0_b.mem",
            tower0_b
        );

        $readmemh(
            "generated_dual_lane/tower1_b.mem",
            tower1_b
        );

        $readmemh(
            "generated_dual_lane/tower0_expected.mem",
            tower0_expected
        );

        $readmemh(
            "generated_dual_lane/tower1_expected.mem",
            tower1_expected
        );
        ...
        $display(
            "Parallel two-tower core cycles: %0d",
            core_cycles_lane0
        );
