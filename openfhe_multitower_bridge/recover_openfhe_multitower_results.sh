...
TOWER_COUNT="${1:?usage: $0 TOWER_COUNT PRODUCT_COUNT}"
PRODUCT_COUNT="${2:?usage: $0 TOWER_COUNT PRODUCT_COUNT}"
...
echo
echo "PASS: recovered and verified the existing FPGA result set"
