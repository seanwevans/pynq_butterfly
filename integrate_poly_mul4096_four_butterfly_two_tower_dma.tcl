...
set board_test_source [file join $source_root test_poly_mul4096_four_butterfly_two_tower_dma.py]
set board_run_source [file join $source_root run_poly_mul4096_four_butterfly_two_tower_board.sh]
